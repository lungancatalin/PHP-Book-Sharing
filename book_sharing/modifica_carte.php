...
<!DOCTYPE html>
    <html>
    <head>
        <title><?php $informatie["titlu_site"]; ?> -Panoul de control </title>
    ...
    <div class="container continut panou">
        <section>
            <?php if ( isset( $_SESSION['id'] ) && $utilizator_logat['status'] == 'Admin' ) { ?>
            <article>
                <h2 class="titlu-site">Modifica cartea</h2>
                ...
                <form action="panou.php#carti" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="nume" value="<?php echo $carte['titlu_carte']; ?>">
                    </fieldset>
                        ...
                        <select name="categorie" id="categorie">
                            ...
                            if(mysqli_num_rows($categorii) > 0) {
                                while($categorie = mysqli_fetch_assoc($categorii)) {
                                    ...
                                    echo '<option value="' . $categorie["id_categorie"] . '" ' . $selected . '>' . $categorie["nume_categorie"] . '</option>';
                                }
                            }
                            ?>
                        </select>
                    ...
                    <fieldset>
                        ...
                        <input type="text" name="autor" value="<?php echo $carte['autor_carte']; ?>" >
                    </fieldset>

                    <fieldset>
                        <label for="editura">Editura cartii: </label>
                        <input type="text" name="editura" value="<?php echo $carte['editura_carte']; ?>">
                    </fieldset>

                    <fieldset>
                        <label for="editura">Descriere: </label>
                        <textarea name="descriere"><?php echo $carte['descriere']; ?></textarea>
                    </fieldset>

                    <fieldset>
                        <label for="data">Anul aparitiei: </label>
                        <input type="date" name="data" value="<?php echo $carte['anul_aparitiei']; ?>">
                    </fieldset>

                    <fieldset>
                        <label for="pagini">Numarul de pagini: </label>
                        <input type="text" name="pagini" value="<?php echo $carte['numar_pagini']; ?>">
                    </fieldset>

                    <fieldset>
                        <label for="stoc">Disponibilitate/buc: </label>
                        <input type="text" name="stoc" value="<?php echo $carte['stoc']; ?>">
                    </fieldset>

                    <fieldset>
                        <button type="submit" name="modifica-carte">Modifica</button
                    </fieldset>
                </form>
            </article>
            <?php } else { ?>
